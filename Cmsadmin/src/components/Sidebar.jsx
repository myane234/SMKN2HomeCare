                ...
                return (
                  <div key={item.label} className="flex flex-col">
                    ...
                    >
                      ...
                      {!collapsed && (
                        <span
                          className={`ml-auto text-[11px] transition-transform ${masterDataOpen ? "rotate-180" : ""}`}
                        >
                          ▼
                        </span>
                      )}
                    ...
                    {(masterDataOpen || collapsed) && (
                      <div
                        className={`mt-1 flex flex-col gap-1 ${collapsed ? "" : "ml-2 border-l border-slate-200/80 pl-2"}`}
                      >
                        {item.children.map((child) => {
                          if (child.type === "subgroup") {
                            const isWilayah = child.label === "Wilayah";
                            const isOpen = isWilayah
                              ? wilayahOpen
                              : pembayaranOpen;
